...
string g_image_folder = "";                  // 图像文件夹
string g_stamp_folder = "None";              // 时间戳文件夹
string g_calib_path = "";                    // 矫正文件路径
string g_result_name = "KeyFrameTrajectory"; // 结果文件名
...
int main(int argc, char **argv)
{
    ...
    {
        cerr << endl
             << "Minimal Usage: ./test_dataset  image=PATH_TO_IMAGE_FOLDER  calib=PATH_TO_CALIBRATION" << endl;
        return 1;
    }
